                ...
                @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="position" class="form-control" id="position" value="{{ $users->position }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="office">{{ __('Office') }}</label>
                            <input type="text" name="office" class="form-control" id="office" value="{{ $users->office }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="age">{{ __('Age') }}</label>
                            <input type="number" name="age" class="form-control" id="age" value="{{ $users->age }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label for="role">{{ __('Role') }}</label>
                            <select name="role" id="role" value="{{ $users->role }}" class="form-control">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="date" name="startdate" class="form-control" id="startdate" value="{{ $users->startdate }}">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input type="password" name="password" disabled class="form-control" id="password" value="{{ $users->password }}">
                        </div>
                        <div>
